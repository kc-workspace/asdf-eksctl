...
KC_ASDF_NAME="asdf-eksctl"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-eksctl"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="eksctl"
KC_ASDF_APP_WEBS="https://eksctl.io/"
KC_ASDF_APP_DESC="a simple CLI tool for creating and managing clusters on EKS - Amazon's managed Kubernetes service for EC2."
KC_ASDF_APP_REPO="https://github.com/eksctl-io/eksctl"
